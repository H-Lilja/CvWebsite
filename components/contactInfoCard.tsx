...
export default function ContactInfoCard() {
    ...
    return (
      ...
      <div className="p-5 lg:p-10 grid  place-self-center pastel-animation mx-12 md:mx-auto lg:mx-96  mt-40 md:mt-20 3xl:mt-56 rounded-md">
        {/* title of the contact card */}
        <h2 className="abel-regular text-pink-300 text-center mb-3 3xl:text-4xl">{t("title")}</h2>
        <div className="flex gap-10 justify-center mb-3">
          {/* using mailto link for email */}
          <a href="mailto:heidi.lilja99@outlook.com">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ff80c0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-mail  w-6 h-6 3xl:w-12 3xl:h-12"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
          </a>
        ...
        <p className='abel-regular text-white text-center 3xl:text-4xl'>{t("tel")}</p>
      </div>
    );
  }