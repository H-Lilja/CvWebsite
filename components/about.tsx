...
function About() {
  // get the json selection for homePAge
      ...
      const pClass = skillTitle === 'Taidot' ? "abel-regular mr-20 text-nowrap mb-28 lg:mb-0 ml-9 lg:ml-0 lg:text-2xl" : "abel-regular mr-5 text-nowrap mb-28 lg:mb-0 ml-9 lg:ml-0 lg:text-2xl"; // Example styles
  ...
  return (
    ...
    <div className='z-2 mt-4 grid place-items-center' >
      {/* first title in page */}
     <h1 className='source-serif-4 place-self-start ml-4 mt-2 lg:mt-4 xl:text-4xl'>{t("greeting")}</h1>
     {/* name title */}
     <h1 className='limelight-big place-self-start ml-3 mt-1 lg:mt-0 xl:text-9xl xl:mt-4'>Heidi Lilja</h1>
     {/* jobtitle after name and svg for the > mark */}
     <div className='flex gap-1 place-self-start ml-4 mt-72 lg:mt-0 mr-10 lg:mr-0 xl:mt-4'>
     <h2 className='source-serif-4 place-self-start -mt-1 mr-12 lg:mr-0  xl:text-4xl'>{t("myTitle")}</h2>
     </div>

     {/* Image of self in page */}
      <Image
        className= "w-56 h-56 md:w-80 md:h-80  lg:w-96 lg:h-96 object-cover rounded-full ml-5 md:ml-0 lg:ml-96 lg:mt-10 lg:-mr-40 md:mr-60 -mt-80 md:-mt-20 md:place-self-end place-self-start lg:place-self-center"
        src={imageUrl} 
        alt="Heidi"
      ...
      <div className='flex gap-3 place-self-start md:place-self-end lg:place-self-end mb-20 md:mb-24 lg:mb-60 mr-0 lg:mr-60 ml-6 lg:ml-0 mt-16 lg:mt-20'>
        <a href="https://www.instagram.com/heidiliilja/" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ff80c0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-instagram w-6 h-6 lg:w-12 lg:h-12"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>       
        </a>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#ff80c0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-github w-6 h-6 lg:w-12 lg:h-12"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>        </a>
      </div>
      ...
      <div className='mb-28 lg:mb-20 w-auto bg-zinc-800'>
        ...
        <div className="lg:flex grid mt-4">
          <h1 className='abel-regular text-4xl lg:text-6xl  mx-9'>{t("title")}</h1>
          <h1 className='hidden lg:flex abel-regular text-4xl lg:text-6xl  mb-2 ml-auto  mr-44'>{t("skillTitle")}</h1>
        </div>
          {/* Title and text for skill section before > part the sections are stacked on mobile,
          hence why the titles are twice*/}
         <div className="grid lg:flex">
          <p className="abel-regular ml-9 mr-9 lg:mr-64 lg:text-start lg:text-3xl mb-8">{t("about")}</p>
        ...
        <div className='absolute top-0  left-9 lg:right-0 -mt-24 mb-20 lg:place-self-end lg:text-xl'>
